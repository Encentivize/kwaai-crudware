...
var crudWare=function(connectionString,connectionOptions)
{
    var _kwaaiCrudTools=kwaaiCrud.crudTools(connectionString,connectionOptions);
...
module.exports=function(connectionString,connectionOptions){
    return new crudWare(connectionString,connectionOptions);
}
